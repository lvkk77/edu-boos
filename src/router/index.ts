  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: 'ResourceClassify' */ '@/views/resource-classify/index.vue'
          )
      },
      {
        path: '/course',
      ...
      },
      {
        ...
        name: 'advert-create',
        component: () =>
          import(/* webpackChunkName: 'advert' */ '@/views/advert/create.vue')
      },
      {
        path: '/advert/:advertId/edit',
        name: 'advert-edit',
        component: () =>
          import(/* webpackChunkName: 'advert' */ '@/views/advert/edit.vue'),
        props: true
      },
      {
        path: '/advert-space',
      ...
      {
        path: '/advert-space/addAdvertiseSpace',
        name: 'addAdvertiseSpace',
        component: () =>
          import(
            /* webpackChunkName: 'addAdvertiseSpace' */ '@/views/advert-space/create.vue'
          )
      },
      {
        path: '/advert-space/:id/updateAdvertiseSpace',
        name: 'updateAdvertiseSpace',
        component: () =>
          import(
            /* webpackChunkName: 'updateAdvertiseSpace' */ '@/views/advert-space/edit.vue'
          ),
        props: true
      },
